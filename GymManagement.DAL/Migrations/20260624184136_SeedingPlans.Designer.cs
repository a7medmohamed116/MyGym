...
namespace GymManagement.DAL.Migrations
{
    ...
    [Migration("20260624184136_SeedingPlans")]
    partial class SeedingPlans
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManagement.DAL.Models.Member", b =>
                {
                    ...
                    b.Property<DateOnly>("DareOfBirth")
                        .HasColumnType("date");
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("EmailCheck", "Email like '_%_@_%._%'");

                            t.HasCheckConstraint("PhoneCheck", "Phone like '010%'or Phone like'012%' or Phone like'011%' or Phone like'015%'");
                        });
                });
            ...
            modelBuilder.Entity("MyGym.Models.Plan", b =>
                {
                    ...
                    b.ToTable("Plans", t =>
                        {
                            t.HasCheckConstraint("DeurationCheck", "DurationDays BETWEEN 1 AND 365");
                        });
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Unlimited access to gym equipment ,classes and sauna",
                            DurationDays = 90,
                            IsActive = false,
                            Name = "Premium Plan",
                            Price = 900m,
            ...
            modelBuilder.Entity("GymManagement.DAL.Models.Membership", b =>
                {
                    ...
                    b.HasOne("MyGym.Models.Plan", "Plan")
                        .WithMany("Memberships")
