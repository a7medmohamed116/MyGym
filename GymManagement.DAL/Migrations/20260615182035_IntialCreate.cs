        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DareOfBirth = table.Column<DateOnly>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCheck", "Email like '_%_@_%._%'");
                    table.CheckConstraint("PhoneCheck", "Phone like '010%'or Phone like'012%' or Phone like'011%' or Phone like'015%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("DeurationCheck", "DurationDays BETWEEN 1 AND 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCheck1", "Email like '_%_@_%._%'");
                    table.CheckConstraint("PhoneCheck1", "Phone like '010%'or Phone like'012%' or Phone like'011%' or Phone like'015%'");
                });
